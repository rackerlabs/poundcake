    ...
    class _FakeInsert:
        def __init__(self):
            self.inserted = SimpleNamespace(
                ...
                expected_duration_sec="i_expected_duration_sec",
                timeout_duration_sec="i_timeout_duration_sec",
                retry_count="i_retry_count",
                retry_delay="i_retry_delay",
                on_failure="i_on_failure",
