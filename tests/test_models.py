...
def test_recipe_model_creation():
    ...
    recipe = Recipe(
        name="TestRecipe", st2_workflow_ref="test.workflow", task_list="task1,task2,task3"
    )
...
def test_oven_model_creation():
    ...
    oven = Oven(req_id="test-req-123", recipe_id=1, action_id="test-action-id", status="pending")
