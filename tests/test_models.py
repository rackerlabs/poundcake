...
def test_recipe_model_creation():
    ...
    recipe = Recipe(name="TestRecipe", description="Testing Recipe Model", enabled=True)
...
def test_oven_model_creation():
    ...
    oven = Oven(
        req_id="test-req-123", recipe_id=1, ingredient_id=1, task_order=1, processing_status="new"
    )
