...
export POUNDCAKE_CREATE_IMAGE_PULL_SECRET="${POUNDCAKE_CREATE_IMAGE_PULL_SECRET:-false}"
...
#   export POUNDCAKE_CHART_VERSION="0.2.109"
#
...
echo "  Override dir: ${POUNDCAKE_SERVICE_CONFIG_DIR}"
